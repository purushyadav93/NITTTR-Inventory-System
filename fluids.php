...
<center>
    <div class="main">
        <form id="uploadForm" action="insert2.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
...
<center>
<div class="main1">
<form id="dateBillForm" action="fluids.php" method="POST" class="form-horizontal1">
...
<div class="container mt-3">
    <form action="fluids.php" method="GET" class="form-horizontal">
        <div class="form-group">
